...
-(NSArray *)tiles
{
    ...
    tile4.story = @"You have found a parrot can be used in your armor slot! Parrots are a great defender and are fiercely loyal to their captain.";
    ...
    tile9.backgroundImage =[UIImage imageNamed:@"PirateTreasurer.jpeg"];
